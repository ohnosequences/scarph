...
object edge {
  ...
  trait GetSource[E <: AnyEdge] extends Fn1[ValueOf[E]] with Out[ValueOf[SourceOf[E]]]

  trait GetTarget[E <: AnyEdge] extends Fn1[ValueOf[E]] with Out[ValueOf[TargetOf[E]]]
