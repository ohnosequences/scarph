...
\setcounter{secnumdepth}{0}
  ...
  \title{\LARGE \bfseries Scarph: a implementation of the dagger categorical model for graph data}

% authors
\usepackage{authblk}
  \author[1]{\normalsize Alexey Alekhin}
...
\lhead{\titlefont Scarph: a implementation of the dagger categorical model for graph data}
...
%     \title{\huge {Scarph: a implementation of the dagger categorical model for graph data}}
...
\section{Introduction}\label{introduction}
  ...
  \printbibliography[title=Design]
